...
export default function ActionPanel() {
  ...
  if (!timeline) {
    return (
      <div className="w-64 border-r bg-background hidden md:flex items-center justify-center">
  ...
  return (
    <div className="w-64 border-r bg-background hidden md:flex flex-col h-full">
      {/* Header */}
